...
export default function UserAdd() {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(createUser)} noValidate>
      ...
      <input type="submit" value={t('user.add.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 mt-6" />
    </form>
  </>);
}

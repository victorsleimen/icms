...
export default function TicketEdit() {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(updateTicket)} noValidate>
      <input type="submit" value={t('ticket.edit.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 mt-6 mb-5" />
      <InputRow useFormResult={useFormResult} object="ticket" field="id" disabled={true} type="number" />
      ...
      <input type="submit" value={t('ticket.edit.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 mt-6" />
    </form>
  </>);
}
